<?php
function headlineViewDesktop($category,$jml){
	global $post;
	...
	public function widget( $args, $instance ) {
		if($instance['mobile'] == 'yes'){
			if (function_exists( 'is_amp_endpoint' ) && is_amp_endpoint()) {
				headlineViewMobile($instance['headline'], $instance['amountheadlinemobile']);
			}elseif (wp_is_mobile()) {
				headlineViewMobile($instance['headline'], $instance['amountheadlinemobile']);
			}
		}
		if($instance['desktop'] == 'yes'){
			if (function_exists( 'is_amp_endpoint' ) && is_amp_endpoint()) {
				...
				headlineViewDesktop($instance['headline'], $instance['amountheadlinedesktop']);
			}
		}
	}
