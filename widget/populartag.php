	...
	<?php endif; ?>
		<div class="widget-content">
			<?php foreach ( (array) $tags as $tag ) { 
				if($tag->description !=""):
					$ver = '<i class="tag-snippet__topic-icon i-checklist icon-tag"></i>';
				else:
					$ver = "";
				endif;
				...
				<div class="populartag-item">
					...
					<h3 class="popular-title">
						<a href="<?php echo get_tag_link ($tag->term_id); ?>" class="media-link">
							<span class="tag-title"><?php echo $tag->name; ?></span>
							<?php echo $ver; ?>
						</a>
					</h3>
				</div>
