...
function addscript() {
        ...
        if(is_category()) :
            ...
            wp_enqueue_script('tiny', get_stylesheet_directory_uri() . '/assets/js/jquery.tinycarousel.min.js',  array(), $versi, true );
        endif;
        if(is_home()) :
...
if(is_admin()):
wp_enqueue_script('jsonp', get_stylesheet_directory_uri() . '/assets/js/image.js', array('jquery'));
endif;
?>