...
*   **Lisensi GPL v2**: Bebas digunakan dan dimodifikasi.

## 📥 Instalasi

1.  Unduh tema sebagai file `.zip` dari repositori ini atau dari [halaman rilis](https://github.com/mokesano/liputanwp/releases).
...
*   MySQL versi **5.6** atau MariaDB versi **10.0** atau lebih tinggi.
...
Anda dapat melihat pratinjau tema di:  
👉 [https://wizdam.sangia.org/demo/liputanwp/](https://wizdam.sangia.org/demo/liputanwp/)
